...
public class MysqlTourDao implements TourDao {
	...
	// bude metoda aj pre getAllTours()? ked sa bude chciet vyhladavat bez filtrov v appke
...
////		String sql = "SELECT id, title, bio, maxSlots, image , user_id, location_id FROM tour";
...
////						Integer maxSlots = rs.getInt("maxSlots");
////						Blob image = rs.getBlob("image");
////						User guideman = rs.getUser
////						
////						
////						return null;
////					}
...
//		String sql = "SELECT id, title, bio, maxSlots, image , user_id, location_id FROM tour " + "WHERE id = " + id;
//		try {
